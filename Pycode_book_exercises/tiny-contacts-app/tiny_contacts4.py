...
class Contact:              # Define  a classe Contact
    ...
    # o init é estatico pois ele só pode ser invocado pela 
    # classe que deverá construir
    def __init__(self,name, address, phone, hours_worked = 0):
...
def display_contact():
    ...
    if contact != None:          
        ...
        print('Hours worked: ', contact.get_hours_worked()) # Metodo GET de contatos
        input('Pressione qualquer tecla para continuar. ')
    else: 
